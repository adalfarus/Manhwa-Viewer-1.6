...
class ProviderPluginGoogle(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.google.com", logo_path="./data/GoogleLogo.png")
...
class ProviderPluginDuckDuckGo(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.duckduckgo.com", logo_path="./data/DuckDuckGoLogo.png")
...
class ProviderPluginBing(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.bing.com", logo_path="./data/BingLogo.png")
...
class ProviderPluginManhwaClan(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.manhwaclan.com", logo_path="./data/ManhwaClanLogo.png")
...
class ProviderPluginMangaKakalot(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website=None, logo_path="./data/MangaKakalotLogo.png")
    ...
    def _make_cache_readable(self):
        ...
        for i, file in enumerate(numerical_files):
            ...
            # Rename the file
            os.rename(os.path.join(self.cache, file), os.path.join(self.cache, new_name))
        ...
        #    with open(os.path.join(self.cache, f"{count:03d}"), 'wb') as img_file: # f"00{count}"[-3:]
        #        img_file.write(img_data)
        
class ProviderPluginMangaDex(ProviderPlugin): # W.I.P
    def __init__(self, title, chapter, provider):
        self.title = title
...
class ProviderPluginMangaQueen(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.mangaqueen.com", logo_path="./data/MangaQueenLogo.png")
...
class ProviderPluginMangaGirl(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.mangagirl.me", logo_path="./data/MangaGirlLogo.png")
...
class ProviderPluginMangaBuddy(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.mangabuddy.com", logo_path="./data/MangaBuddyLogo.png")
...
class ProviderPluginS2Manga(ProviderPlugin):
    def __init__(self, title, chapter, provider):
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.s2manga.com", logo_path="./data/S2MangaLogo.png")
...
class ProviderPluginNovelCool(ProviderPlugin): # W.I.P
    def __init__(self, title, chapter, provider):
        self.logo_path = './data/logo3.png'
        return
        super().__init__(title=title, chapter=chapter, provider=provider, specific_provider_website="www.novelcool.com", logo_path="./data/NovelCoolLogo.png")
